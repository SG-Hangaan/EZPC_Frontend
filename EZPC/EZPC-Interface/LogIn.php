  ...
  <div id="nav_menu">
    ...
    <nav id="nav_buttons">
      <ul>
        ...
        <li><a>Store</a>
          <ul>
            <li><a href="./ShopRAM.php">Graphic Card</a></li>
            <li><a href="./ShopRAM.php">Monitors</a></li>
            <li><a href="./ShopRAM.php">Motherboard</a></li>
            <li><a href="./ShopRAM.php">Mouse & Keyboard</a></li>
            <li><a href="./ShopRAM.php">Power & Supply</a></li>
          </ul>
        </li>
        <li><a href="./Contacts.php">Contact</a></li>
      </ul>
